...
Canonical surface: **60 agents · 232 skills · 75 commands**. Categories are derived from component names; pick the entry whose description fits your task.
...
| `nodejs-patterns` | Node.js runtime patterns — ESM modules, async/streams, graceful shutdown, environment/config validation, error handling, and security for production Node services. |
...
| `typescript-patterns` | Idiomatic TypeScript patterns, strict-mode type design, discriminated unions, async correctness, and error handling for building robust, maintainable TypeScript applications. |
| `typescript-testing` | TypeScript testing patterns with Vitest and Jest — typed test doubles, async and timer control, contract tests at boundaries, and coverage. Follows TDD with idiomatic TypeScript practices. |
